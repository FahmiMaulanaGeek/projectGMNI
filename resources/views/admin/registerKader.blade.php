    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('registerKader') }}">
                        @csrf
                        ...
                        <div class="row mb-3">
                            <label for="dpkid" class="col-md-4 col-form-label text-md-end">{{ __('DPK ID') }}</label>

                            <div class="col-md-6">
                                <select name="dpkid" id="dpkid" class="form-control @error('dpkid') is-invalid @enderror">
                                    @foreach ($data as $dpk)
