	...
	<div class="image-aboutus-banner"style="margin-top:1px">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
			<h1 class="lg-text">GMNI SURABAYA</h1>
			<p class="image-aboutus-para">BAGI MAHASISWA ILMU PENGETAHUAN ADALAH DARAHNYA,DISKUSI ADALAH DENYUT NADINYA DAN PERGEREKAN ADALAH NAFASNYA</p>
		</div>
		</div>
	</div>
	</div>
