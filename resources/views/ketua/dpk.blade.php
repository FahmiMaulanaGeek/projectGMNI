                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('addDpk') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="universitas" type="text" class="form-control @error('universitas') is-invalid @enderror" name="universitas" value="{{ old('universitas') }}" required autocomplete="universitas" autofocus>
