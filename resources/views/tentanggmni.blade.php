...
<div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 p-0">
  <div class="tm-flex-center p-5 tm-bg-color-primary">
    <div class="tm-max-w-400 tm-flex-center tm-flex-col">
      <img src="assets/img/image-04.jpg" alt="Image" class="rounded-circle mb-4">
...
<section class="row tm-section tm-mb-30">
  <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 p-0 text-center">
    <img src="assets/img/image-01.jpg" alt="Image" class="img-fluid">
  </div>
  <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
    <div class="tm-flex-center p-5">
...
<div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 text-xl-right text-md-center text-center mt-5 mt-lg-0 pr-lg-0">
 <img src="assets/img/image-02.jpg" alt="Image" class="img-fluid">
</div>
</section>
...
<section class="row tm-section tm-mb-30">
  <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 p-md-0 text-md-center text-center mb-4 mb-lg-0">
   <img src="assets/img/image-03.jpg" alt="Image" class="img-fluid">
 </div>
...
{{-- <section>
  <div class="container">
    <div class="row">
      <div class='col-lg-12'>
        <iframe width="560" height="315" src="https://www.youtube.com/embed/aEvPBfM7OSQ" title="YouTube video player" 
...
<a href="https://wa.me/6281333303969?
text=%0AMERDEKA!!!%0A
Saya%20tertarik%20untuk%20bergabung%20GMNI.%0A
Nama:%0A
Universitas:%0A
Angkatan:%0A
Fakultas:%0A
Jurusan:%0A"> Text Us</a> --}}